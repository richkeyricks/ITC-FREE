...
new_code = """    def _build_ai_page(self):
        ...
        self.ai_provider = ctk.StringVar(value=os.getenv("AI_PROVIDER", "Groq"))
        ctk.CTkSegmentedButton(row_a, values=["Groq", "OpenRouter", "Ollama"], 
        ...
        for name, url in [("Get Groq", "https://console.groq.com/keys"),
                          ("Get OpenRouter", "https://openrouter.ai/keys"), 
