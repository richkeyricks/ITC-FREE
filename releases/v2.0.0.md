...
# 🚀 Changelog Page & Price Preview Update v2.0.0 (24 Jan 2026)

**INTELLIGENCE TELEGRAM COPYTRADE (ITC) +AI**
*Official Production Build - Changelog Page & Price Preview Update*

Introducing absolute transparency via an integrated Changelog page, alongside live-evaluating SL/TP price visualization metrics.

### ⚡ Changelog Page & Price Preview Update Updates
*   📋 Implemented Changelog Page enabling total visibility of historical updates!
*   🔧 Brilliant Live SL/TP Price Preview evaluation interface.
*   📊 Fluid Symbol Selector navigating natively through FOREX, GOLD, and JPY currencies.

### 📦 Installation
1.  **Download** the [**ITC_ProMax_AI_Trading_Assistant_v2.0.0.zip**](https://github.com/richkeyricks/ITC-FREE/releases/download/v2.0.0/ITC_ProMax_AI_Trading_Assistant_v2.0.0.zip) below.
2.  **Extract** to your preferred high-performance directory.
3.  **Run** the executable inside the package.
4.  No Python installation required.

[**Download Release v2.0.0 ZIP**](https://github.com/richkeyricks/ITC-FREE/releases/download/v2.0.0/ITC_ProMax_AI_Trading_Assistant_v2.0.0.zip)
